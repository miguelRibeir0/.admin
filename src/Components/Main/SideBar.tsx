...
const SideBar: React.FC<{ isOpen: boolean }> = ({ isOpen }) => {
  return (
    <>
      ...
      />
      <div
        className={`fixed left-0 top-0 z-20 mt-20 h-screen w-1/2 bg-white transition-transform duration-500 sm:w-1/3 lg:w-1/4 xl:w-1/6 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
