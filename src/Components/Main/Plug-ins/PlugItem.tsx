...
const PlugItem: React.FC<PlugItemProps> = ({ url, description, status }) => {
  return (
    <div>
      <div className="flex min-h-44 w-full cursor-pointer flex-col items-center gap-y-7 rounded-lg border-2 border-orange-500 pb-10 pt-10 shadow-md lg:h-72">
      ...
      <div className="flex h-10 w-full items-center gap-x-3 rounded-lg rounded-t-none border-2 border-t-0 border-orange-500">
